...
class InstallmentLoadedSuccessfullyState extends InstallmentsState {
  ...
  const InstallmentLoadedSuccessfullyState({
    required this.installemnt,
  });
}
...
class InstallmentGetOneSuccessfullyState extends InstallmentsState {
  final Employee employee;
  final Installment installment;

  const InstallmentGetOneSuccessfullyState({
